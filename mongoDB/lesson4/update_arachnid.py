        ...
        for line in reader:
            ...
            for field, val in line.iteritems():
                ...
                if field == "binomialAuthority_label":
                    binomialAuthority = val
                else:
                    label = val
            data[label] = binomialAuthority
    return data
...
def update_db(data, db):
    # YOUR CODE HERE
    for key in data:
        arachnid_update = db.arachnid.find({"label": key})
        for a in arachnid_update:
            a["classification"]["binomialAuthority"] = data[key]
            #print a["classification"]
            db.arachnid.save(a)
            #print a["classification"]["binomialAuthority"]
...
"""
 'binomialAuthority_label': set([<type 'NoneType'>,
                                 <type 'list'>,
                                 <type 'str'>]),
"""