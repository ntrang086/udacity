...
html_page = "options.html"  # downloadfrom http://www.transtats.bts.gov/Data_Elements.aspx?Data=2
...
def extract_carriers(page):
    ...
    with open(page, "r") as html:
        ...
        airlines = soup.find(id="CarrierList").find_all("option")
...
def test():
    ...
    assert len(data) == 14  # In Udacity's file it was 16, but there have been changes to the website
    assert "5Y" in data # In Udacity's file it was FL, but there have been changes to the website
    assert "NK" in data
